 ...
 *
 * Example — trigger a 40 MB soft limit and 64 MB hard limit:
 *   ./memory_test 10 8   # allocates up to 80 MB, should hit hard limit
 */
...
int main(int argc, char *argv[])
{
    ...
    printf("[memory_test] PID=%d, allocating %lu × %lu MB chunks\n",
